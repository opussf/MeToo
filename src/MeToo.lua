		...
		if isOwned then
			...
			if( (not currentPet) or
				...
				if( MeToo_options.companionSuccess_doEmote and strlen( MeToo_options.companionSuccess_emote ) > 0 ) then
					DoEmote( MeToo_options.companionSuccess_emote, MeToo_options.companionSuccess_useTarget and "target" or "player" )
				end
			else
			...
			if( MeToo_options.companionFailure_doEmote and strlen( MeToo_options.companionFailure_emote ) > 0 ) then
				DoEmote( MeToo_options.companionFailure_emote, MeToo_options.companionFailure_useTarget and "target" or "player" )
			end
